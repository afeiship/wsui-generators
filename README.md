...
@include generator-box-rem($box-list,'p');
@include generator-box-rem($box-list,'pt');
@include generator-box-rem($box-list,'pr');
@include generator-box-rem($box-list,'pl');
@include generator-box-rem($box-list,'pb');
@include generator-box-rem($box-list,'px');
@include generator-box-rem($box-list,'py');
